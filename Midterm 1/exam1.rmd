...
You should render it as an .html document in order to be able to see figures and pictures.
...
# in theory would use code from homework eight and use this fucntion to complete - I tired using the pander package and plugging in this fucntion to the CrossTable but I could not leave in the code when I uploaded so I took it out
```
